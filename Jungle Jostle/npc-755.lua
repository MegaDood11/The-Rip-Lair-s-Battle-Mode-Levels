...
local kritterSettings = {
	...
	jumpXSpeed = 2.85, -- The X speed the NPC gets when jumping. (Only affects yellow kritters.)
	jumpYSpeed = -7.5, -- The Y speed the NPC gets when jumping. (Only affects blue, black, yellow, and purple kritters.)
}
...
ai.register(npcID,ai.TYPE_JUMPER)
