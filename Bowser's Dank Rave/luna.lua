...
function onTick()
	if battleTimer.isActive and battleTimer.secondsLeft == battleTimer.optionTimeValues[battleOptions.getModeRuleset().timeLimit] - 89 and thing1.value == 0 then
		triggerEvent("bowserbootup")
		thing1.value = 1
	end
	if battleTimer.isActive and battleTimer.secondsLeft == 61 and thing2.value == 0 then
