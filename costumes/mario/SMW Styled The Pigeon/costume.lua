--[[
	...
	Updated SMW Mario Costume
	by MrDoubleA

	Mo Willems, and Disney Hyperton Books: 'The Pigeon' Liscence
	GlacialSiren484, MauricioN64, Mushrunt, AwesomeZack, Jamestendo64, LinkStormZ, and Amer1ciuM: Sprite sheet for SMB3 Powerups.
	RunninPigeon: Creation of these sprites.
]]
...
goaltape.registerVictoryPose("SMW-Pigeon",28,29) -- this allows the player to use a custom frame after getting a goal tape
