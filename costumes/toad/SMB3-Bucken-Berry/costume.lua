...
goaltape.registerVictoryPose("SMM2-SMB3-Toad",28, 29) -- this allows the player to use a custom frame after getting a goal tape
...
local animations = {
	...
	crouchSlowFall = {36,37,38, frameDelay = 5},
