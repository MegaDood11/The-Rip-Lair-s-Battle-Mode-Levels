...
battleStars.spawnTimeMin = lunatime.toTicks(50)
battleStars.spawnTimeMax = lunatime.toTicks(65)
battleStars.spawnTimeStart = lunatime.toTicks(10)
...
local function canSpawnStars()
    return (battleGeneral.mode == battleGeneral.gameMode.CLASSIC and not battleMessages.victoryActive and onlinePlay.currentMode ~= onlinePlay.MODE_CLIENT)
end
