...
local rouletteBlock = require("AI/rouletteBlock")
...
local sampleBlockSettings = {
	...
	-- roulette Block specific
	contentPriority = -66, -- the render priority of the content of the block. If > -65, it will be drawn in front the block instead of behind.
...
function sampleBlock.onInitAPI()
	rouletteBlock.register(blockID)
end
